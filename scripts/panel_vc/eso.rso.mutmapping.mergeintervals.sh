...
maxIt_pval=100
maxlines=$(wc -l ${intermediate_dir}/genes_filtered.bed | awk '{print $1}')
...
Rscript ${SCRIPTDIR}/panel_vc/mutmapping.mergeintervals.R $intermediate_dir $maxIt_pval $maxlines 
source deactivate
